...
namespace WebApplication2.Controllers
{
    public class IdeasController : Controller
    {
        ...
        List<Comment> GetComments(int Id) {
            List<Comment> comments = db.Comments.Include(x => x.Reply).Include(y=>y.Author).ToList();
        ...
        public void SendEmail(Idea idea)
        {
            string subject = idea.IdeaTitle;
            string body = "Content : "+idea.IdeaContent + ",Description : "+idea.IdeaDescription;
            var client = new SmtpClient("smtp.gmail.com", 587)
            {
                Credentials = new NetworkCredential("mail here", "password here"),
                EnableSsl = true
            };
            client.Send("mail here", "send to what email", subject, body);
        ...
        public ActionResult DownloadCSV(string Submission)
        {
            ...
            builder.AppendLine("Id,Title,Description,Content,Created date,Last modified,Category,Anonymous,Author");
          

            foreach(Idea idea in ideas)
            {
                builder.AppendLine($"{idea.IdeaId},{idea.IdeaTitle},{idea.IdeaDescription},{idea.IdeaContent},{idea.Created_date},{idea.Last_modified},{idea.Category.CateName},{idea.Anonymous},{idea.Author.UserName}");
            }
        ...
        public ActionResult Analysis(string Submission)
        {
